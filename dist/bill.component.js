...
window.billComponent = Vue.extend({
    ...
    data: function data() {
        return {
            menus: [{ name: "DashBoard", routeName: 'dashboard' }, { name: "Contas a pagar", routeName: 'bill-pay.list', dropdownId: 'bill-pay.list' }, { name: "Contas a receber", routeName: 'bill-receive.list', dropdownId: 'bill-receive.list' }],
            menusDropdown: [{
